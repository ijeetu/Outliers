// ------------------------------------------------
// Project Name: Outliers - Coming Soon and Landing Page Template
// Project Description: Outliers - awesome coming soon template to kick-start your project
...
$(function() {
  ...
  // KBW-Countdown Start
  // --------------------------------------------- //
  $('#countdown').countdown({until: $.countdown.UTCDate(+10, 2025, 1, 1), format: 'D'});
  // --------------------------------------------- //
  // KBW-Countdown End
  // --------------------------------------------- //
